...
MainWindow::MainWindow(QWidget* parent)
  ...
  QObject::connect(this, &MainWindow::colorChanged, scribbleArea,
                   &image::setToolColor);

  QObject::connect(this, &MainWindow::needToSave, scribbleArea,
                   &image::saveAsImage);

  QObject::connect(this, &MainWindow::needToOpenImg, scribbleArea,
                   &image::openImage);

  QObject::connect(this, &MainWindow::scaleIn, scribbleArea,
                   &image::scaleImageZoomIn);

  QObject::connect(this, &MainWindow::scaleOut, scribbleArea,
                   &image::scaleImageZoomOut);

  QObject::connect(this, &MainWindow::undo, scribbleArea, &image::undoFunc);

  QObject::connect(this, &MainWindow::redo, scribbleArea, &image::redoFunc);

  QObject::connect(this, &MainWindow::widthChanged, scribbleArea,
                   &image::setBrushWidth);

  QObject::connect(this, &MainWindow::toolChanged, scribbleArea,
                   &image::setTool);

  QObject::connect(this, &MainWindow::needToCrop, scribbleArea,
                   &image::needToCrop);

  QObject::connect(scribbleArea, &image::activatedUndo, this,
                   &MainWindow::activateUndo);

  QObject::connect(this, &MainWindow::newSheet, scribbleArea, &image::newSheet);

  QObject::connect(this, &MainWindow::needToResize, scribbleArea,
...
void MainWindow::on_actionOpen_triggered() {
  QString filename = QFileDialog::getOpenFileName(
      this, tr("Open Picture"), path, tr("Image Files (*.png *.jpg *.jpeg)"));
